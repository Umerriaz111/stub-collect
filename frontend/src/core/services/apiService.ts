...
import axios, { AxiosInstance, AxiosResponse, AxiosError, isCancel } from 'axios'
import { checkExpiry, getToken, saveToken, getRefreshToken, saveRefreshToken } from './authService'
...
interface ApiService {
    ...
    setRateLimit(): void
    resetRateLimit(): void
    get(resource: string, slug?: string, params?: any, baseURL?: string): Promise<any>
    getWithAbort(resource: string, slug?: string, params?: any, baseURL?: string): [Promise<any>, AbortController]
    post(resource: string, params?: any, slug?: string, isFormData?: boolean, baseURL?: string): Promise<any>
    patch(resource: string, params?: any, slug?: string, isFormData?: boolean, baseURL?: string): Promise<any>
    patchWithAbort(resource: string, params?: any, slug?: string, isFormData?: boolean, baseURL?: string): [Promise<any>, AbortController]
    put(resource: string, slug?: string, params?: any, isFormData?: boolean, baseURL?: string): Promise<any>
    delete(resource: string, slug?: string, params?: any, isFormData?: boolean, baseURL?: string): Promise<any>
}
...
export const handleError = (error: unknown & { status?: number }, customMessage?: string): void => {
    if (error?.status === 401) {
        return
    }
...
const ApiService: ApiService = {
                    ...
                    if (!isTokenValid) {
                        ...
                        try {
                            ...
                            if (response.data?.accessToken) {
                                store.dispatch(SET_TOKEN_EXPIRED(false))
    ...
    // set token  in header
    setAuthToken(token) {
        if (this.instance) this.instance.defaults.headers['Authorization'] = `Bearer ${token || getToken()}`
    },
    ...
    get(resource: string, slug: string = '', params: unknown = {}, baseURL?: string): Promise<any> {
    ...
    getWithAbort(resource: string, slug: string = '', params: unknown = {}, baseURL?: string): [Promise<any>, AbortController] {
    ...
    post(resource: string, params: unknown = {}, slug: string = '', isFormData: boolean = false, baseURL?: string): Promise<any> {
        return new Promise((resolve, reject) => {
            this.setAuthToken()
            if (!baseURL) this.setDefaultBaseUrl(configService.VITE_APP_API_BASE_URL)
            ...
            this.instance
                ...
                ?.post(`${resource}${slug ? `/${slug}` : ''}`, params, { headers, baseURL })
                .then(res => {
                    resolve(res.data)
                })
                .catch(error => {
    ...
    patch(resource: string, params: unknown = {}, slug: string = '', isFormData: boolean = false, baseURL?: string): Promise<any> {
        return new Promise((resolve, reject) => {
            this.setAuthToken()
            ...
            this.instance
                ...
                ?.patch(`${resource}${slug ? `/${slug}` : ''}`, params, { headers, baseURL })
                .then(res => {
                    resolve(res.data)
                })
                .catch(error => {
    ...
    put(resource: string, slug?: string, params?: any, isFormData?: boolean, baseURL?: string): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this.instance
                ...
                ?.put(`${resource}${slug ? `/${slug}` : ''}`, params, { headers, baseURL })
                .then(res => {
                    resolve(res.data)
                })
                .catch(error => {
    ...
    delete(resource: string, slug: string = '', params: unknown = {}, isFormData: boolean = false, baseURL?: string): Promise<any> {
        this.setAuthToken()
        const headers = isFormData ? { 'Content-Type': 'multipart/form-data' } : { 'Content-Type': 'application/json' }
        ...
        return new Promise((resolve, reject) => {
            ...
            this.instance
                ...
                ?.delete(`${resource}${slug ? `/${slug}` : ''}`, { headers, data: params, baseURL })
                .then(res => {
                    resolve(res.data)
                })
                .catch(error => {
