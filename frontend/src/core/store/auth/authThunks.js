...
import { saveToken, destroyToken, saveUserEmail, saveUser, getTempToken, getUser, destroyTempKeys } from '../../services/authService'

import ApiService, { handleError } from '../../services/apiService'
...
export const login = credentials => {
    return async dispatch => {
        try {
            ...
            if (!error?.data?.message?.credentials) handleError(error?.data?.message || 'Something went wrong')
        }
    }
}
